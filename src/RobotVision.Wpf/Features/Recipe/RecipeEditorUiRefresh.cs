...
internal static class RecipeEditorUiRefresh
{
    ...
    [
        ...
        nameof(RecipeViewModel.EditorStationId),
        nameof(RecipeViewModel.EditorCameraId),
        ...
        nameof(RecipeViewModel.IsDualTemplateMode),
        nameof(RecipeViewModel.IsModelFreeMode),
        nameof(RecipeViewModel.UsesSecondarySearchRoi),
        nameof(RecipeViewModel.ShowBlobExpandWindow),
        nameof(RecipeViewModel.ShowDualTemplateExpand),
        nameof(RecipeViewModel.HasDualTemplateA),
        nameof(RecipeViewModel.HasDualTemplateB),
        nameof(RecipeViewModel.DualTemplateStatusText),
        nameof(RecipeViewModel.DetectionRoiCheckText),
        nameof(RecipeViewModel.SecondaryRoiCheckText),
        nameof(RecipeViewModel.SecondaryRoiHintText),
        ...
        nameof(RecipeViewModel.ShowMatchThreshold),
