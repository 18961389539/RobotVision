...
| 1018 | ProcessUnhealthy | 过程联锁 | 连续失败达阈值(未检出/取图失败/精修失败等) | 排除光源/来料/相机后,解除联锁(CLEARINHIBIT) |
| 1019 | RefineFailed | 精修失败 | 分割已检出但精修未过门（匹配/卡尺/孔槽/头尾） | 查照明与精修方法；不要当漏检。配方可勾选回退粗角 |
...
5. **1007/1019/1018** → 检测质量:来料 / 光源 / 精修不过门 / 联锁
