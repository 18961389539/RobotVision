...
/// RefreshAsync 内部 IO 与缩略图解码已全部下沉 Task.Run（线程池），
/// 因此测试直接 async/await 即可，无需 RunSta——
/// 若在 RunSta 的 UI 线程内 GetAwaiter().GetResult() 会与 continuation 互等而死锁。
/// </summary>
public class FailuresViewModelTests
{
    [Fact]
    public async Task Refresh_WhenFolderMissing_ShowsHint()
    {
    ...
    [Fact]
    public async Task Refresh_WithRetentions_CollectsFiltersAndOrdersDescending()
    {
    ...
    [Fact]
    public async Task RecipeFilter_FiltersItemsAndUpdatesSummary()
    {
    ...
    [Fact]
    public async Task CombinedFilter_RecipeAndErrorCode()
    {
    ...
    [Fact]
    public async Task Filter_ThatMatchesNothing_ShowsEmptyItems()
    {
    ...
    [Fact]
    public async Task Refresh_WhenJsonMissing_StillListsPng()
    {
